...
const calFont = fetch(new URL("../../../../public/fonts/cal.woff", import.meta.url)).then((res) =>
  res.arrayBuffer()
);

const interFont = fetch(new URL("../../../../public/fonts/Inter-Regular.woff", import.meta.url)).then((res) =>
  res.arrayBuffer()
);

const interFontMedium = fetch(new URL("../../../../public/fonts/Inter-Medium.woff", import.meta.url)).then(
  (res) => res.arrayBuffer()
);
