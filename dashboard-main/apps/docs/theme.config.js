...
const themeConfig = {
  ...
  titleSuffix: " | Coglify.com",
  logo: <h4 className="m-0">Coglify.com</h4>,
  head: (
    <>
      ...
      <meta name="twitter:site:domain" content="docs.coglify.com" />
      <meta name="twitter:url" content={DOCS_URL} />
      <meta name="og:title" content="Coglify.com Documentation" />
      <meta name="og:image" content={SEO_IMG_DEFAULT} />
      <meta name="apple-mobile-web-app-title" content="Coglify.com Docs" />
  ...
  footerText: <>© {new Date().getFullYear()} Coglify.com, Inc. All rights reserved.</>,
};
