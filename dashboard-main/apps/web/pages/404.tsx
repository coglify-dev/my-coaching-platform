...
export default function Custom404() {
  ...
  const isCalcom = process.env.NEXT_PUBLIC_WEBAPP_URL === "https://coglify.com";
  /**
  ...
  return (
    <>
      ...
      <div className="bg-default min-h-screen px-4" data-testid="404-page">
        <main className="mx-auto max-w-xl pt-16 pb-6 sm:pt-24">
          {isSignup && process.env.NEXT_PUBLIC_WEBAPP_URL !== "https://coglify.com" ? (
            <div>
              <div>
                ...
                <p className="mt-4">{t("signup_requires_description", { companyName: "Coglify.com" })}</p>
              </div>
              <div className="mt-12">
