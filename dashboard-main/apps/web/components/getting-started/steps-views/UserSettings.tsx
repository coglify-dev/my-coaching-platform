      ...
      <div className="space-y-6">
        ...
        <div className="w-full">
          ...
          <input
            ...
            autoComplete="off"
            autoCorrect="off"
            className="hover:border-emphasis border-default bg-default placeholder:text-muted text-emphasis disabled:bg-subtle disabled:hover:border-subtle !my-0 mb-0 mt-0 block h-9 w-full rounded-md  border py-2 px-3 text-sm leading-4 !ring-0 focus:border-neutral-300 focus:outline-none focus:ring-2 focus:ring-neutral-800 focus:ring-offset-1 disabled:cursor-not-allowed"
          />
          {errors.name && (
