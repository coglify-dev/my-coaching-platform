...
export const WEBSITE_URL = process.env.NEXT_PUBLIC_WEBSITE_URL || "https://coglify.com";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Coglify.com";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "help@coglify.com";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Coglify.com, Inc.";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "Coglify";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "Coglify.com";

// This is the URL from which all Cal Links and their assets are served.
// Use website URL to make links shorter(coglify.com and not app.coglify.com)
...
export const CONSOLE_URL =
  new URL(WEBAPP_URL).hostname.endsWith(".cal.dev") || process.env.NODE_ENV !== "production"
    ...
    : `https://console.coglify.com`;
export const IS_SELF_HOSTED = !(
  new URL(WEBAPP_URL).hostname.endsWith(".cal.dev") || new URL(WEBAPP_URL).hostname.endsWith(".coglify.com")
);
...
export const LOGO_ICON = "/logo-white.svg";
export const ROADMAP = "https://cal.com/roadmap";
export const DESKTOP_APP_LINK = "https://coglify/download";
export const JOIN_SLACK = "https://coglify/slack";
export const POWERED_BY_URL = `${WEBSITE_URL}/?utm_source=embed&utm_medium=powered-by-button`;
export const DOCS_URL = "https://coglify/docs";
export const DEVELOPER_DOCS = "https://developer.coglify";
