...
import type { UserType } from "@calcom/prisma/enums";
  ...
  CredentialsProvider({
    ...
    async authorize(credentials) {
      ...
      return {
        ...
        isCoachVerified: user.isCoachVerified,
      };
    },
  }),
    ...
    async jwt({ token, user, account }) {
      ...
      if (account.type === "oauth") {
        ...
        return {
          ...
          isCoachVerified: existingUser.isCoachVerified,
        };
      }
    ...
    async session({ session, token }) {
      ...
      const calendsoSession: Session = {
        ...
        user: {
          ...
          isCoachVerified: token.isCoachVerified as boolean,
        },
      };
